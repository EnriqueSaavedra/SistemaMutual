...
<!--                <a href="#" class="list-group-item" >Ingresos Por Usuario</a>-->
                <a href="<?=Link::getRutaHref('SUPERVISOR', 'estadisticas/chartEstadisticas/rechazosPorUsuario')?>" class="list-group-item active" >Rechazos Por Usuario</a>
            </div>
        </div>
...
<script>
    ...
    function requestData(usuarios) {
            $.ajax({
                method:'POST',
                url: "<?=Link::getRuta("SUPERVISOR","rest/estadisticas/restRechazosPorUsuario")?>",
                data:{
                    usuarios:usuarios
                },
